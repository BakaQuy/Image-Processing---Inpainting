...
/// MY NEW FUNCTION!!! ///
// flattenedKernels mat is a width^2 by width^2 mat of the form: [g(1) g(2) g(3) ... g(w^2)], where g(i) is a flattened kernel
...
// flattenedKernel mat is a 1 by width^2 mat which is a flattened centralized gaussian kernel
