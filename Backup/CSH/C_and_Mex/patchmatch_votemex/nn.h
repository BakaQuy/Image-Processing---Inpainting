...
BITMAP *weighted_vote(Params *p, BITMAP *a, BITMAP *b, double *accum,
             ...
             RegionMasks *amask=NULL, BITMAP *aweight=NULL, BITMAP *ainit=NULL, double *flattenedKernels=NULL,
             RegionMasks *region_masks=NULL, BITMAP *aconstraint=NULL, int mask_self_only=0, int factor = 1, int cutoff = 1000);


BITMAP *weighted_KNN_vote(Params *p, int K_of_KNN , BITMAP *a, BITMAP *b, double *accum,
             BITMAP **a_knn, BITMAP *bmask=NULL, BITMAP *bweight=NULL,
             double coherence_weight=COHERENCE_WEIGHT, double complete_weight=COMPLETE_WEIGHT,
             RegionMasks *amask=NULL, BITMAP *aweight=NULL, BITMAP *ainit=NULL, double *flattenedKernels=NULL,
             RegionMasks *region_masks=NULL, BITMAP *aconstraint=NULL, int mask_self_only=0, int factor = 1, int cutoff = 1000);

BITMAP *weighted_KNN_dispersion_vote(Params *p, int K_of_KNN , BITMAP *a, BITMAP *b, double *accum,
             BITMAP **a_knn, BITMAP **b_knn=NULL,
             BITMAP *bmask=NULL, BITMAP *bweight=NULL,
             double coherence_weight=COHERENCE_WEIGHT, double complete_weight=COMPLETE_WEIGHT,
             RegionMasks *amask=NULL, BITMAP *aweight=NULL, BITMAP *ainit=NULL, double *flattenedKernels=NULL,
             RegionMasks *region_masks=NULL, BITMAP *aconstraint=NULL, int mask_self_only=0, int factor = 1, int cutoff = 1000);
...
BITMAP *single_local_vote(Params *p, BITMAP *a, BITMAP *b, double *accum,
             BITMAP *bmask=NULL, BITMAP *bweight=NULL,
             double coherence_weight=COHERENCE_WEIGHT, double complete_weight=COMPLETE_WEIGHT,
             RegionMasks *amask=NULL, BITMAP *aweight=NULL, BITMAP *ainit=NULL, double *flattenedKernel=NULL,
             RegionMasks *region_masks=NULL, BITMAP *aconstraint=NULL, int mask_self_only=0, int factor = 1, int cutoff = 1000, int radius = 10);
